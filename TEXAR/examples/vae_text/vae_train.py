...
def _main(_):
    ...
    save_dir = "./print_models/%s" % config.dataset
        ...
        while True:
            try:
                ...
                if epoch%30==0 and epoch!=0:
                    ...
                    print('recon_0: ', ' '.join([train_data.vocab.id_to_token_map_py[i] for i in dic['rec'][0]]))
                    print('refer_0: ', ' '.join([train_data.vocab.id_to_token_map_py[i] for i in dic['ref'][0]]))
                    print('\n')
                    #print('recon_1: ', ' '.join([train_data.vocab.id_to_token_map_py[i] for i in dic['rec'][1]]))
                    #print('refer_1: ', ' '.join([train_data.vocab.id_to_token_map_py[i] for i in dic['ref'][1]]))
                    #print('\n')
                    #print('recon_2: ', ' '.join([train_data.vocab.id_to_token_map_py[i] for i in dic['rec'][2]]))
                    #print('refer_2: ', ' '.join([train_data.vocab.id_to_token_map_py[i] for i in dic['ref'][2]]))
                    #print('\n')
                    ###################################
