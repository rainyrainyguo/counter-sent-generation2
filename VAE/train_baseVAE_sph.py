...
def save_model():
    ...
    torch.save(model.state_dict(), 'models/{}.bin'.format('pre_yelp128_all_sent_trainVAE_sph_less100'))   
...
for it in range(1000000):
    ...
    if it%1000==0:
        print("saving model pre_yelp128_all_sent_trainVAE_sph_less100.bin")
        print("\n")
        save_model()
